...
from .ncsnpp_utils import layers, layerspp, normalization, dit
...
@BackboneRegistry.register("ncsn_dit_mid")
class NCSNDiTmid(nn.Module):
    @staticmethod
    ...
    def __init__(self,
        ...
        **unused_kwargs
        ...
        in_ch = hs_c[-1]
        modules.append(DiTBlock(hidden_size=in_ch, num_heads=heads))
        modules.append(AttnBlock(channels=in_ch))
        modules.append(DiTBlock(hidden_size=in_ch, num_heads=heads))
